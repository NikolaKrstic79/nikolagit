...
<div class="jumbotron jumbotron-fluid text-center yellowbg text-white">
      <div class="container">
        <h1 class="display-4 text-dark"><b>NO PAYMENT NEED FOR NOW THIS IS ONLY A TEST SITE :)</b></h1>
        <!-- GET STARTED FORM -->
        <a href="{{ route('moviebrowse') }}" class="btn btn-outline-danger">Continue after a payment</a>
