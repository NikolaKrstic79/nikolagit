...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="{{ Auth::check() ? '#' : route('index') }}"> <img class="logosize" src="{{ URL('images/logo.png') }}" alt="Brainster-Logo.png"> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link text-dark" href="{{ Auth::check() ? '#' : route('login') }}">LogOut</a>
        </li>
      </ul>
    </div>
  </div>
